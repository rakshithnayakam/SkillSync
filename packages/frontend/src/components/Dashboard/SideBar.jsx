...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar fixed top-16 left-0 w-64 h-[calc(100vh-4rem)] shadow-xl z-30">
            ...
            <button
              ...
              className={`w-full flex items-center p-3 rounded-xl transition-colors ${
                isActive
                  ...
                  : "text-secondary hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-800"
              }`}
            >
              {IconComponent && (
                <IconComponent
                  className={`h-6 w-6 mr-3 ${isActive ? "text-white" : "text-muted"}`}
                />
              )}
              {item.name}
            </button>
