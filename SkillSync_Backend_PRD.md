...
- **Role-Based Access Control (RBAC):**  
  Four-tier permission system — *Admin*, *Mentor*, *Learner*, *Hybrid*.  
...
- **Mutual Exchange Matching:**  
  Match users where *Skill A (offered)* by User 1 = *Skill A (wanted)* by User 2.  
...
- **Session Status:**  
  Track session as *Requested*, *Confirmed*, *Completed*, or *Cancelled*.  
...
**Document Owner:** [Your Name], Product Lead — SkillSync  
**Version:** 1.0.0  
